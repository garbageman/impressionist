...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuSquare:
                ...
                return true;
            case R.id.menuPoint:
                Toast.makeText(this, "Point Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Point);
                return true;
            case R.id.menuSpray:
                Toast.makeText(this, "Spray Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.SprayPaint);
                return true;
        }
        return false;
    }
    ...
    private void saveBitmap() {
        ...
        String guessedFilename = "Image_" + IMAGE_COUNT;
        IMAGE_COUNT++;
